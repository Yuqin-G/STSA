...
class iImageNetA(iData):
    ...
    def download_data(self):
        ...
        train_dir = "~/data/ina/imagenet-a/train/"
        test_dir = "~/data/ina/imagenet-a/test/"
...
class TinyImageNet200(iData):   # 200*500=10w, 5 tasks, each task=40*500=2w
    ...
    def download_data(self):
        train_dst = TinyImageNet('~/data/tiny-imagenet-200/', split='train', transform=self.train_trsf, download=True)
        val_dst = TinyImageNet('~/data/tiny-imagenet-200/', split='val', transform=self.test_trsf, download=True)
